            ...
            <Accordion.Item value="analytics">
              ...
              <Accordion.Panel>
                ...
                <List spacing="xs" mb={15}>
                  ...
                  >
                    Cookies that collect information about how you use our website
                  </List.Item>
                  <List.Item
                    icon={
                      <ThemeIcon color="blue" size={24} radius="xl">
                  ...
                  >
                    Cookies that help us measure the effectiveness of our marketing
                  </List.Item>
                </List>
              </Accordion.Panel>
            </Accordion.Item>
            ...
            <Accordion.Item value="advertising">
              ...
              <Accordion.Panel>
                ...
                <List spacing="xs" mb={15}>
                  ...
                  >
                    Cookies used by advertising networks to serve personalized ads
                  </List.Item>
                  <List.Item
                    icon={
                      <ThemeIcon color="blue" size={24} radius="xl">
            ...
            <Accordion.Item value="social">
              ...
              <Accordion.Panel>
                ...
                <List spacing="xs" mb={15}>
                  ...
                  >
                    Cookies set by social media platforms when you share our content
                  </List.Item>
                  <List.Item
                    icon={
                      <ThemeIcon color="blue" size={24} radius="xl">
                  ...
                  >
                    Cookies that enable social media features on our website
                  </List.Item>
                  <List.Item
                    icon={
                      <ThemeIcon color="blue" size={24} radius="xl">
                  ...
                  >
                    Cookies that help track the effectiveness of social sharing
                  </List.Item>
                </List>
              </Accordion.Panel>
            </Accordion.Item>
